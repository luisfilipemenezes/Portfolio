...
export default function Example() {
  ...
  return (
    <header className="shadow-lg bg-gradient-to-r font-abc tracking-widest from-slate-900 to-cyan-950 ">
      <nav className="mx-auto  flex flex-row-reverse md:flex-row max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
